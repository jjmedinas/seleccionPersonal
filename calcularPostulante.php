...
class OperacionesPostulante{
    ...
    function subirArchivo(){
      ...
      $updirArchivo="C:/AppServ/www/seleccionPersonal/uploads/";
    ...
    function leerArchivo(){
        ...
        $contLin=0;
            ...
            $archivo = fopen("C:/AppServ/www/seleccionPersonal/uploads/datos.txt",r);  //Se abre en archivo en modo de solo lectura 
  ...
  //       var_dump($this->arregloPostulantes);
    ...
    function imprimirResultado(){
     ...
     $auxPostulante=$this->arregloPostulantes[$indicePostulante];  // se saca el postulante con el menor valor final  del arreglo de postulantes
